#include "Graphics/DX11/DX11ShadowMapService.h"

namespace SFW
{
	namespace Graphics::DX11
	{
        bool ShadowMapService::Initialize(ID3D11Device* device,
        ...
        bool ShadowMapService::Resize(ID3D11Device* device,
            std::uint32_t width,
            std::uint32_t height)
        {
            if (!device) return false;
        ...
        bool ShadowMapService::CreateResources(ID3D11Device* device)
        {
